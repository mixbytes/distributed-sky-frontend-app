...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    dsAccountsModule: {
      [key: string]: QueryableStorageEntry<ApiType>;
      accountRegistry: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<AccountOf>> & QueryableStorageEntry<ApiType>;
      uavRegistry: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<UAVOf>> & QueryableStorageEntry<ApiType>;
    };
    dsMapsModule: {
      [key: string]: QueryableStorageEntry<ApiType>;
      areaData: AugmentedQueryDoubleMap<ApiType, (key1: RootId | null, key2: AreaId | null) => Observable<Area>> & QueryableStorageEntry<ApiType>;
      redZones: AugmentedQuery<ApiType, (arg: ZoneId | null) => Observable<ZoneOf>> & QueryableStorageEntry<ApiType>;
      rootBoxes: AugmentedQuery<ApiType, (arg: RootId | null) => Observable<RootBoxOf>> & QueryableStorageEntry<ApiType>;
      totalRoots: AugmentedQuery<ApiType, () => Observable<RootId>> & QueryableStorageEntry<ApiType>;
    };
    grandpa: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
