...
import type { Bytes, Compact, Option, Vec, u32, u64, u8 } from '@polkadot/types';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    dsAccountsModule: {
       ...
       **/
      accountAdd: AugmentedSubmittable<(account: AccountId | string | Uint8Array, role: AccountRole | null) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      accountDisable: AugmentedSubmittable<(whom: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Register an entry in account registry with PILOT role.
       **/
      registerPilot: AugmentedSubmittable<(account: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      registerUav: AugmentedSubmittable<(serialNumber: SerialNumber | null, meta: MetaIPFS | null, uavAddress: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    dsMapsModule: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      changeAreaType: AugmentedSubmittable<(rootId: RootId | null, areaId: AreaId | null, areaType: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds new root to storage
       **/
      rootAdd: AugmentedSubmittable<(boundingBox: Box3D | null, delta: Coord | null) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes root by given id, and zones inside. This means, function might be heavy.
       **/
      rootRemove: AugmentedSubmittable<(rootId: RootId | null) => SubmittableExtrinsic<ApiType>>;
      /**
       * Form index and store input to redzones, creates area struct if it doesnt exist
       **/
      zoneAdd: AugmentedSubmittable<(rect: Rect2D | null, height: LightCoord | null, rootId: RootId | null) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes zone by given id
       **/
      zoneRemove: AugmentedSubmittable<(zoneId: ZoneId | null) => SubmittableExtrinsic<ApiType>>;
    };
    grandpa: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
